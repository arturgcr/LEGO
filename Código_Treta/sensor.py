...
class Sensoriamento():
    ...
    # lembrando q esse sensordireita, sensoresquerda e sensormeio são OBJETOS herdados da classe sensor  
        ...
        self.erroAnterior = vistoUltimo*15 

        for i in listadesensores:
            if i.lado == 'esquerda':
                self.sensoresEsquerda.append(i) #adiciona i a lista da esquerda
            if i.lado == 'direita':
                self.sensoresDireita.append(i) #adiciona i a lista da direita
            if i.lado == 'meio':
